...
import (
	pilotmonitoring "istio.io/istio/pilot/pkg/util/monitoring"
...
var (
	...
	configPushes = monitoring.NewSum(
		pilotmonitoring.StackdriverPrefix+"config_pushes_count",
	...
	rejectedConfigs = monitoring.NewGauge(
		pilotmonitoring.StackdriverPrefix+"rejected_configs",
...
func init() {
	if pilotmonitoring.UseStackdriverStandardMetrics() {
